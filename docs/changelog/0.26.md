...
> `TelemetryConfig` is reshaped; [§20](../UPGRADING.md#20-the-sdk-uploads-its-own-telemetry-v0260)
...
> signature;
> [§21](../UPGRADING.md#21-delivery-state-survives-a-restart-and-two-defaults-grow-v0260)
...
- **An Apple privacy manifest** shipped with the pod, and
  [docs/privacy.md](../privacy.md) with the store disclosures.
