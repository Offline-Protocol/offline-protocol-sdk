...
Everything in the first eight rows is generated by
`tools/spec-vectors/generate.py`, a second implementation of these encodings
written from the chapters, which never reads the crates it pins. A vector
