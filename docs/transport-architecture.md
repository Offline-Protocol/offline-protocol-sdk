...
6. Platform reports outcome:
   ...
   - Reticulum: reticulumConfirmSent(messageId) or reticulumSendFailedWithReason(messageId, reason), on the gateway's verdict
