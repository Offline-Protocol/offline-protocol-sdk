...
impl MlsStorageAdapter {
    ...
    fn read_generic<K: Serialize, V: DeserializeOwned>(&self, label: &str, key: &K) -> Result<Option<V>, MlsError> {
        ...
        match data {
             Some(bytes) => {
                 let v = serde_json::from_slice(&bytes).map_err(|e| MlsError::Deserialization(e.to_string()))?;
                 Ok(Some(v))
             }
             None => Ok(None)
        }
...
impl<const VERSION: u16> StorageProvider<VERSION> for MlsStorageAdapter {
    ...
    fn write_mls_join_config<GroupId: traits::GroupId<VERSION>, MlsGroupJoinConfig: traits::MlsGroupJoinConfig<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn append_own_leaf_node<GroupId: traits::GroupId<VERSION>, LeafNode: traits::LeafNode<VERSION>>(
        &self,
        group_id: &GroupId,
        leaf_node: &LeafNode,
    ) -> Result<(), Self::Error> {
    ...
    fn queue_proposal<GroupId: traits::GroupId<VERSION>, ProposalRef: traits::ProposalRef<VERSION>, QueuedProposal: traits::QueuedProposal<VERSION>>(
        &self,
        group_id: &GroupId,
        ...
        let mut list: Vec<(ProposalRef, QueuedProposal)> = self.read_generic(label, group_id)?.unwrap_or_default();
    ...
    fn write_interim_transcript_hash<GroupId: traits::GroupId<VERSION>, InterimTranscriptHash: traits::InterimTranscriptHash<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn write_context<GroupId: traits::GroupId<VERSION>, GroupContext: traits::GroupContext<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn write_confirmation_tag<GroupId: traits::GroupId<VERSION>, ConfirmationTag: traits::ConfirmationTag<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn write_group_state<GroupState: traits::GroupState<VERSION>, GroupId: traits::GroupId<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn write_message_secrets<GroupId: traits::GroupId<VERSION>, MessageSecrets: traits::MessageSecrets<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn write_resumption_psk_store<GroupId: traits::GroupId<VERSION>, ResumptionPskStore: traits::ResumptionPskStore<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn write_own_leaf_index<GroupId: traits::GroupId<VERSION>, LeafNodeIndex: traits::LeafNodeIndex<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn write_group_epoch_secrets<GroupId: traits::GroupId<VERSION>, GroupEpochSecrets: traits::GroupEpochSecrets<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn write_signature_key_pair<SignaturePublicKey: traits::SignaturePublicKey<VERSION>, SignatureKeyPair: traits::SignatureKeyPair<VERSION>>(
        &self,
    ...
    fn write_encryption_key_pair<EncryptionKey: traits::EncryptionKey<VERSION>, HpkeKeyPair: traits::HpkeKeyPair<VERSION>>(
        &self,
    ...
    fn write_encryption_epoch_key_pairs<GroupId: traits::GroupId<VERSION>, EpochKey: traits::EpochKey<VERSION>, HpkeKeyPair: traits::HpkeKeyPair<VERSION>>(
        &self,
        group_id: &GroupId,
        epoch: &EpochKey,
        leaf_index: u32,
        ...
        let key = Key { group_id, epoch, leaf_index };
        self.write_generic("encryption_epoch_key_pairs", &key, key_pairs)
    }

    fn write_key_package<HashReference: traits::HashReference<VERSION>, KeyPackage: traits::KeyPackage<VERSION>>(
        &self,
    ...
    fn mls_group_join_config<GroupId: traits::GroupId<VERSION>, MlsGroupJoinConfig: traits::MlsGroupJoinConfig<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn own_leaf_nodes<GroupId: traits::GroupId<VERSION>, LeafNode: traits::LeafNode<VERSION>>(
        ...
        Ok(self.read_generic("own_leaf_nodes", group_id)?.unwrap_or_default())
    }

    fn queued_proposal_refs<GroupId: traits::GroupId<VERSION>, ProposalRef: traits::ProposalRef<VERSION>>(
        &self,
        group_id: &GroupId,
    ) -> Result<Vec<ProposalRef>, Self::Error> {
        let proposals: Vec<(ProposalRef, serde_json::Value)> = self.read_generic("queued_proposals", group_id)?.unwrap_or_default();
        Ok(proposals.into_iter().map(|(r, _)| r).collect())
    }

    fn queued_proposals<GroupId: traits::GroupId<VERSION>, ProposalRef: traits::ProposalRef<VERSION>, QueuedProposal: traits::QueuedProposal<VERSION>>(
        &self,
        group_id: &GroupId,
    ) -> Result<Vec<(ProposalRef, QueuedProposal)>, Self::Error> {
        Ok(self.read_generic("queued_proposals", group_id)?.unwrap_or_default())
    }
    ...
    fn group_context<GroupId: traits::GroupId<VERSION>, GroupContext: traits::GroupContext<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn interim_transcript_hash<GroupId: traits::GroupId<VERSION>, InterimTranscriptHash: traits::InterimTranscriptHash<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn confirmation_tag<GroupId: traits::GroupId<VERSION>, ConfirmationTag: traits::ConfirmationTag<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn message_secrets<GroupId: traits::GroupId<VERSION>, MessageSecrets: traits::MessageSecrets<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn resumption_psk_store<GroupId: traits::GroupId<VERSION>, ResumptionPskStore: traits::ResumptionPskStore<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn own_leaf_index<GroupId: traits::GroupId<VERSION>, LeafNodeIndex: traits::LeafNodeIndex<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn group_epoch_secrets<GroupId: traits::GroupId<VERSION>, GroupEpochSecrets: traits::GroupEpochSecrets<VERSION>>(
        &self,
        group_id: &GroupId,
    ...
    fn signature_key_pair<SignaturePublicKey: traits::SignaturePublicKey<VERSION>, SignatureKeyPair: traits::SignatureKeyPair<VERSION>>(
        &self,
        public_key: &SignaturePublicKey,
    ...
    fn encryption_key_pair<HpkeKeyPair: traits::HpkeKeyPair<VERSION>, EncryptionKey: traits::EncryptionKey<VERSION>>(
        &self,
        public_key: &EncryptionKey,
    ...
    fn encryption_epoch_key_pairs<GroupId: traits::GroupId<VERSION>, EpochKey: traits::EpochKey<VERSION>, HpkeKeyPair: traits::HpkeKeyPair<VERSION>>(
        &self,
        group_id: &GroupId,
        epoch: &EpochKey,
        leaf_index: u32,
        ...
        let key = Key { group_id, epoch, leaf_index };
        Ok(self.read_generic("encryption_epoch_key_pairs", &key)?.unwrap_or_default())
    }

    fn key_package<KeyPackageRef: traits::HashReference<VERSION>, KeyPackage: traits::KeyPackage<VERSION>>(
        &self,
    ...
    fn remove_proposal<GroupId: traits::GroupId<VERSION>, ProposalRef: traits::ProposalRef<VERSION>>(
        &self,
        group_id: &GroupId,
        proposal_ref: &ProposalRef,
    ) -> Result<(), Self::Error> {
        let label = "queued_proposals";
        let mut list: Vec<(ProposalRef, serde_json::Value)> = self.read_generic(label, group_id)?.unwrap_or_default();
        let ref_bytes = serde_json::to_vec(proposal_ref).unwrap();
        
        list.retain(|(r, _)| {
            serde_json::to_vec(r).unwrap() != ref_bytes
        });
    ...
    fn clear_proposal_queue<GroupId: traits::GroupId<VERSION>, ProposalRef: traits::ProposalRef<VERSION>>(
        &self,
        group_id: &GroupId,
    ) -> Result<(), Self::Error> {
    ...
    fn delete_encryption_epoch_key_pairs<GroupId: traits::GroupId<VERSION>, EpochKey: traits::EpochKey<VERSION>>(
        &self,
        group_id: &GroupId,
        epoch: &EpochKey,
        leaf_index: u32,
