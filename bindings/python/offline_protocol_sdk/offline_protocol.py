...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_offline_protocol_uniffi_checksum_method_datastore_provide_attachment() != 59967:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_offline_protocol_uniffi_checksum_method_datastore_remove_doc() != 53929:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_offline_protocol_uniffi_checksum_method_offlineprotocol_reject_connection_request() != 496:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_offline_protocol_uniffi_checksum_method_offlineprotocol_rekey_session() != 50324:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_offline_protocol_uniffi_fn_method_datastore_remove_doc.argtypes = (
    ctypes.c_uint64,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_offline_protocol_uniffi_fn_method_datastore_remove_doc.restype = None
_UniffiLib.uniffi_offline_protocol_uniffi_fn_method_datastore_remove_space.argtypes = (
    ctypes.c_uint64,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
...
_UniffiLib.uniffi_offline_protocol_uniffi_fn_method_offlineprotocol_rekey_session.argtypes = (
    ctypes.c_uint64,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_offline_protocol_uniffi_fn_method_offlineprotocol_rekey_session.restype = ctypes.c_int8
...
_UniffiLib.uniffi_offline_protocol_uniffi_checksum_method_datastore_remove_doc.argtypes = (
)
_UniffiLib.uniffi_offline_protocol_uniffi_checksum_method_datastore_remove_doc.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_offline_protocol_uniffi_checksum_method_offlineprotocol_rekey_session.argtypes = (
)
_UniffiLib.uniffi_offline_protocol_uniffi_checksum_method_offlineprotocol_rekey_session.restype = ctypes.c_uint16
...
class DataStoreProtocol(typing.Protocol):
    ...
    def provide_attachment(self, space_id: str,peer_id: str,hash: str,data: bytes) -> None:
        raise NotImplementedError
    def remove_doc(self, space_id: str,doc_id: str) -> None:
        raise NotImplementedError
...
class DataStore(DataStoreProtocol):
    ...
    def remove_doc(self, space_id: str,doc_id: str) -> None:
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_offline_protocol_uniffi_fn_method_datastore_remove_doc,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def remove_space(self, space_id: str) -> None:
...
class OfflineProtocolProtocol(typing.Protocol):
    ...
    def reject_connection_request(self, recipient: str) -> str:
        raise NotImplementedError
    def rekey_session(self, peer_id: str) -> bool:
        raise NotImplementedError
...
class OfflineProtocol(OfflineProtocolProtocol):
    ...
    def rekey_session(self, peer_id: str) -> bool:
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_offline_protocol_uniffi_fn_method_offlineprotocol_rekey_session,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def release_transport_lock(self, ) -> None:
