...
internal object IntegrityCheckingUniffiLib {
    ...
    external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_credit_balance(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_declare_invocation_usage(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_discover_listings(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_discovered_listings(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_get_balance(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_get_receipts(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_invoke_listing(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_mark_receipts_settled(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_pending_receipts(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_publish_adapter_listing(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_publish_listing(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_publisher_reputation(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_pull_adapter(
): Short
external fun uniffi_offline_protocol_uniffi_checksum_method_meshexchange_unpublish_listing(
): Short
...
external fun uniffi_offline_protocol_uniffi_checksum_constructor_meshexchange_new(
): Short
...
internal object UniffiLib {
    ...
    external fun uniffi_offline_protocol_uniffi_fn_clone_meshexchange(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Long
external fun uniffi_offline_protocol_uniffi_fn_free_meshexchange(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Unit
external fun uniffi_offline_protocol_uniffi_fn_constructor_meshexchange_new(`protocol`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Long
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_credit_balance(`ptr`: Long,`currency`: RustBuffer.ByValue,`amountMinor`: Long,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_declare_invocation_usage(`ptr`: Long,`requestId`: RustBuffer.ByValue,`units`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Unit
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_discover_listings(`ptr`: Long,`serviceId`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_discovered_listings(`ptr`: Long,`filterJson`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_get_balance(`ptr`: Long,`currency`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_get_receipts(`ptr`: Long,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_invoke_listing(`ptr`: Long,`provider`: RustBuffer.ByValue,`serviceId`: RustBuffer.ByValue,`method`: RustBuffer.ByValue,`body`: RustBuffer.ByValue,`maxUnits`: Long,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_mark_receipts_settled(`ptr`: Long,`receiptIds`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Unit
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_pending_receipts(`ptr`: Long,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_publish_adapter_listing(`ptr`: Long,`serviceId`: RustBuffer.ByValue,`version`: RustBuffer.ByValue,`capabilities`: RustBuffer.ByValue,`termsJson`: RustBuffer.ByValue,`baseModel`: RustBuffer.ByValue,`baseModelVersion`: RustBuffer.ByValue,`artifactPath`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_publish_listing(`ptr`: Long,`serviceId`: RustBuffer.ByValue,`version`: RustBuffer.ByValue,`capabilities`: RustBuffer.ByValue,`kind`: RustBuffer.ByValue,`termsJson`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_publisher_reputation(`ptr`: Long,`publisher`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_pull_adapter(`ptr`: Long,`provider`: RustBuffer.ByValue,`serviceId`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_offline_protocol_uniffi_fn_method_meshexchange_unpublish_listing(`ptr`: Long,`serviceId`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Byte
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_credit_balance() != 1595.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_declare_invocation_usage() != 63529.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_discover_listings() != 52341.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_discovered_listings() != 37124.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_get_balance() != 5230.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_get_receipts() != 4201.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_invoke_listing() != 59139.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_mark_receipts_settled() != 62669.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_pending_receipts() != 50492.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_publish_adapter_listing() != 37913.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_publish_listing() != 3452.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_publisher_reputation() != 34866.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_pull_adapter() != 61853.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_meshexchange_unpublish_listing() != 4751.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_offline_protocol_uniffi_checksum_method_offlineprotocol_ble_set_peer_mtu() != 19690.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_offline_protocol_uniffi_checksum_constructor_meshexchange_new() != 16465.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
//
public interface MeshExchangeInterface {
    
    fun `creditBalance`(`currency`: kotlin.String, `amountMinor`: kotlin.ULong): kotlin.String
    
    fun `declareInvocationUsage`(`requestId`: kotlin.String, `units`: kotlin.ULong)
    
    fun `discoverListings`(`serviceId`: kotlin.String?): kotlin.String
    
    fun `discoveredListings`(`filterJson`: kotlin.String?): kotlin.String
    
    fun `getBalance`(`currency`: kotlin.String): kotlin.String
    
    fun `getReceipts`(): kotlin.String
    
    fun `invokeListing`(`provider`: kotlin.String, `serviceId`: kotlin.String, `method`: kotlin.String, `body`: kotlin.String, `maxUnits`: kotlin.ULong): kotlin.String
    
    fun `markReceiptsSettled`(`receiptIds`: List<kotlin.String>)
    
    fun `pendingReceipts`(): kotlin.String
    
    fun `publishAdapterListing`(`serviceId`: kotlin.String, `version`: kotlin.String, `capabilities`: Map<kotlin.String, kotlin.String>, `termsJson`: kotlin.String, `baseModel`: kotlin.String, `baseModelVersion`: kotlin.String, `artifactPath`: kotlin.String): kotlin.String
    
    fun `publishListing`(`serviceId`: kotlin.String, `version`: kotlin.String, `capabilities`: Map<kotlin.String, kotlin.String>, `kind`: kotlin.String, `termsJson`: kotlin.String): kotlin.String
    
    fun `publisherReputation`(`publisher`: kotlin.String): kotlin.String
    
    fun `pullAdapter`(`provider`: kotlin.String, `serviceId`: kotlin.String): kotlin.String
    
    fun `unpublishListing`(`serviceId`: kotlin.String): kotlin.Boolean
    
    companion object
}

open class MeshExchange: Disposable, AutoCloseable, MeshExchangeInterface
{
    ...
    UniffiLib.uniffi_offline_protocol_uniffi_fn_constructor_meshexchange_new(
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_offline_protocol_uniffi_fn_free_meshexchange(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_offline_protocol_uniffi_fn_clone_meshexchange(handle, status)
        }
    }

    
    @Throws(ProtocolException::class)override fun `creditBalance`(`currency`: kotlin.String, `amountMinor`: kotlin.ULong): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_credit_balance(
        it,
        FfiConverterString.lower(`currency`),FfiConverterULong.lower(`amountMinor`),_status)
}
    }
    )
    }
    ...
    @Throws(ProtocolException::class)override fun `declareInvocationUsage`(`requestId`: kotlin.String, `units`: kotlin.ULong)
        = 
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_declare_invocation_usage(
        it,
        FfiConverterString.lower(`requestId`),FfiConverterULong.lower(`units`),_status)
}
    }
    ...
    @Throws(ProtocolException::class)override fun `discoverListings`(`serviceId`: kotlin.String?): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_discover_listings(
        it,
    ...
    @Throws(ProtocolException::class)override fun `discoveredListings`(`filterJson`: kotlin.String?): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_discovered_listings(
        it,
        FfiConverterOptionalString.lower(`filterJson`),_status)
}
    }
    )
    }
    ...
    @Throws(ProtocolException::class)override fun `getBalance`(`currency`: kotlin.String): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_get_balance(
        it,
        FfiConverterString.lower(`currency`),_status)
}
    }
    )
    }
    ...
    @Throws(ProtocolException::class)override fun `getReceipts`(): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_get_receipts(
        it,
        _status)
}
    }
    ...
    @Throws(ProtocolException::class)override fun `invokeListing`(`provider`: kotlin.String, `serviceId`: kotlin.String, `method`: kotlin.String, `body`: kotlin.String, `maxUnits`: kotlin.ULong): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_invoke_listing(
        it,
        FfiConverterString.lower(`provider`),FfiConverterString.lower(`serviceId`),FfiConverterString.lower(`method`),FfiConverterString.lower(`body`),FfiConverterULong.lower(`maxUnits`),_status)
}
    }
    )
    }
    ...
    @Throws(ProtocolException::class)override fun `markReceiptsSettled`(`receiptIds`: List<kotlin.String>)
        = 
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_mark_receipts_settled(
        it,
        FfiConverterSequenceString.lower(`receiptIds`),_status)
}
    }
    ...
    @Throws(ProtocolException::class)override fun `pendingReceipts`(): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_pending_receipts(
        it,
        _status)
}
    }
    ...
    @Throws(ProtocolException::class)override fun `publishAdapterListing`(`serviceId`: kotlin.String, `version`: kotlin.String, `capabilities`: Map<kotlin.String, kotlin.String>, `termsJson`: kotlin.String, `baseModel`: kotlin.String, `baseModelVersion`: kotlin.String, `artifactPath`: kotlin.String): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_publish_adapter_listing(
        it,
        FfiConverterString.lower(`serviceId`),FfiConverterString.lower(`version`),FfiConverterMapStringString.lower(`capabilities`),FfiConverterString.lower(`termsJson`),FfiConverterString.lower(`baseModel`),FfiConverterString.lower(`baseModelVersion`),FfiConverterString.lower(`artifactPath`),_status)
}
    }
    )
    }
    ...
    @Throws(ProtocolException::class)override fun `publishListing`(`serviceId`: kotlin.String, `version`: kotlin.String, `capabilities`: Map<kotlin.String, kotlin.String>, `kind`: kotlin.String, `termsJson`: kotlin.String): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_publish_listing(
        it,
        FfiConverterString.lower(`serviceId`),FfiConverterString.lower(`version`),FfiConverterMapStringString.lower(`capabilities`),FfiConverterString.lower(`kind`),FfiConverterString.lower(`termsJson`),_status)
}
    }
    )
    }
    ...
    @Throws(ProtocolException::class)override fun `publisherReputation`(`publisher`: kotlin.String): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_publisher_reputation(
        it,
        FfiConverterString.lower(`publisher`),_status)
}
    }
    )
    }
    ...
    @Throws(ProtocolException::class)override fun `pullAdapter`(`provider`: kotlin.String, `serviceId`: kotlin.String): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_pull_adapter(
        it,
        FfiConverterString.lower(`provider`),FfiConverterString.lower(`serviceId`),_status)
}
    }
    )
    }
    ...
    @Throws(ProtocolException::class)override fun `unpublishListing`(`serviceId`: kotlin.String): kotlin.Boolean {
            return FfiConverterBoolean.lift(
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_meshexchange_unpublish_listing(
        it,
 ...
 * @suppress
 */
public object FfiConverterTypeMeshExchange: FfiConverter<MeshExchange, Long> {
    override fun lower(value: MeshExchange): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): MeshExchange {
        return MeshExchange(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): MeshExchange {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: MeshExchange) = 8UL

    override fun write(value: MeshExchange, buf: ByteBuffer) {
        buf.putLong(lower(value))
    }
}
...
open class OfflineProtocol: Disposable, AutoCloseable, OfflineProtocolInterface
{
    ...
    @Throws(ProtocolException::class)override fun `bleClearPeerMtu`(`peerId`: kotlin.String)
        = 
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_offlineprotocol_ble_clear_peer_mtu(
        it,
    ...
    @Throws(ProtocolException::class)override fun `bleSetPeerMtu`(`peerId`: kotlin.String, `maxPayload`: kotlin.UInt)
        = 
    callWithHandle {
    uniffiRustCallWithError(ProtocolException) { _status ->
    UniffiLib.uniffi_offline_protocol_uniffi_fn_method_offlineprotocol_ble_set_peer_mtu(
        it,
        FfiConverterString.lower(`peerId`),FfiConverterUInt.lower(`maxPayload`),_status)
}
    }
...
data class TransportMetrics (
    ...
    var `rssi`: kotlin.Short?
    , 
    var `bandwidthBps`: kotlin.ULong?
    , 
    var `congestion`: kotlin.Float?
    , 
    var `queueDepth`: kotlin.UInt?
    , 
    var `batteryLevel`: kotlin.UByte?
    , 
    var `isCharging`: kotlin.Boolean?
    , 
    var `relayConnectionCount`: kotlin.UByte?
    , 
    var `isActiveRelay`: kotlin.Boolean?
    , 
    var `deliveryRatio`: kotlin.Float?
    , 
    var `dropRate`: kotlin.Float?
    , 
    var `averageHopCount`: kotlin.Float?
    , 
    var `energyCost`: kotlin.Float?
...
public object FfiConverterTypeTransportMetrics: FfiConverterRustBuffer<TransportMetrics> {
    ...
    override fun allocationSize(value: TransportMetrics) = (
            ...
            FfiConverterOptionalShort.allocationSize(value.`rssi`) +
            FfiConverterOptionalULong.allocationSize(value.`bandwidthBps`) +
            FfiConverterOptionalFloat.allocationSize(value.`congestion`) +
            FfiConverterOptionalUInt.allocationSize(value.`queueDepth`) +
            FfiConverterOptionalUByte.allocationSize(value.`batteryLevel`) +
            FfiConverterOptionalBoolean.allocationSize(value.`isCharging`) +
            FfiConverterOptionalUByte.allocationSize(value.`relayConnectionCount`) +
            FfiConverterOptionalBoolean.allocationSize(value.`isActiveRelay`) +
            FfiConverterOptionalFloat.allocationSize(value.`deliveryRatio`) +
            FfiConverterOptionalFloat.allocationSize(value.`dropRate`) +
            FfiConverterOptionalFloat.allocationSize(value.`averageHopCount`) +
            FfiConverterOptionalFloat.allocationSize(value.`energyCost`)
    )
    ...
    override fun write(value: TransportMetrics, buf: ByteBuffer) {
            ...
            FfiConverterOptionalShort.write(value.`rssi`, buf)
            FfiConverterOptionalULong.write(value.`bandwidthBps`, buf)
            FfiConverterOptionalFloat.write(value.`congestion`, buf)
            FfiConverterOptionalUInt.write(value.`queueDepth`, buf)
            FfiConverterOptionalUByte.write(value.`batteryLevel`, buf)
            FfiConverterOptionalBoolean.write(value.`isCharging`, buf)
            FfiConverterOptionalUByte.write(value.`relayConnectionCount`, buf)
            FfiConverterOptionalBoolean.write(value.`isActiveRelay`, buf)
            FfiConverterOptionalFloat.write(value.`deliveryRatio`, buf)
            FfiConverterOptionalFloat.write(value.`dropRate`, buf)
            FfiConverterOptionalFloat.write(value.`averageHopCount`, buf)
            FfiConverterOptionalFloat.write(value.`energyCost`, buf)
    }
}
 ...
 * @suppress
 */
public object FfiConverterTypeMlsVerbosity: FfiConverterRustBuffer<MlsVerbosity> {
    override fun read(buf: ByteBuffer) = try {
        MlsVerbosity.values()[buf.getInt() - 1]
    } catch (e: IndexOutOfBoundsException) {
        throw RuntimeException("invalid enum value, something is very wrong!!", e)
    }

    override fun allocationSize(value: MlsVerbosity) = 4UL

    override fun write(value: MlsVerbosity, buf: ByteBuffer) {
        buf.putInt(value.ordinal + 1)
    }
}
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeMlsVerbosity: FfiConverterRustBuffer<MlsVerbosity?> {
    override fun read(buf: ByteBuffer): MlsVerbosity? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeMlsVerbosity.read(buf)
    }

    override fun allocationSize(value: MlsVerbosity?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeMlsVerbosity.allocationSize(value)
        }
    }
