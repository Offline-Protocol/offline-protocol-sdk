 ...
 */
int32_t offline_protocol_send_file(struct ProtocolHandle *handle,
 ...
 */
int32_t offline_protocol_process_file_chunk(struct ProtocolHandle *handle,
 ...
 */
int32_t offline_protocol_get_file_progress(struct ProtocolHandle *handle,
                                           const char *file_id,
                                           char *out_progress_json,
                                           uintptr_t out_len);
 ...
 */
int32_t offline_protocol_finalize_file(struct ProtocolHandle *handle,
                                       const char *file_id,
 ...
 */
int32_t offline_protocol_cancel_file_transfer(struct ProtocolHandle *handle, const char *file_id);
 ...
 * Returns SUCCESS on success, or an error code on failure.
 */
int32_t offline_protocol_process(struct ProtocolHandle *handle);
 ...
 * Returns SUCCESS on success, or an error code on failure.
 */
int32_t offline_protocol_pause(struct ProtocolHandle *handle);
 ...
 * Returns SUCCESS on success, or an error code on failure.
 */
int32_t offline_protocol_resume(struct ProtocolHandle *handle);
 ...
 */
int32_t offline_protocol_get_state(struct ProtocolHandle *handle);
 ...
 */
int32_t offline_protocol_receive_message(struct ProtocolHandle *handle,
